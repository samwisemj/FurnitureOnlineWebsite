...
<body>
	<div align="center">
		        <img src="logo.jpg" height="180px" width="280px">
        <br>
		...
		<tr>
         ...
         <td><input type="text" id="name" name="name" value="<%if(session.getAttribute("tname")!=null)%><%=session.getAttribute("tname")%>" required></td>
         </font>
		</tr>
		<tr>
         <td><font color="#FFCC66"><label for="userid">User ID</label></font></td>
         <td><input type="text" id="userid" name="userid" value="<%if(session.getAttribute("tuserid")!=null)%><%=session.getAttribute("tname")%>" required></td>
		</tr>
		<tr>
        ...
        <tr>
         ...
         <td><input type="text" id="address" name="address" value="<%if(session.getAttribute("taddress")!=null)%><%=session.getAttribute("taddress")%>" required></td>
        </tr>
        <tr>
         <td><font color="#FFCC66"><label for="Contact">Contact</label></font></td>
         <td><input type="text" id="contact" name="contact" value="<%if(session.getAttribute("tcontact")!=null)%><%=session.getAttribute("tcontact")%>" required></td>
        </tr>
        <tr>
         <td><font color="#FFCC66"><label for="EmailID">Email ID</label></font></td>
         <td><input type="text" id="email" name="email" value="<%if(session.getAttribute("temail")!=null)%><%=session.getAttribute("temail")%>" required></td>
		</tr>
        </table>
		<%if(message!=null){%>
        ...
        <br>
		 <center><button class="button button1">Create Account</button></center>
